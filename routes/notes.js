module.exports = function(passport) { // passed by app to do login stuff
  ...
  router.get('/:topic/:presentation', loggedIn, function(req, res, next) {
    res.redirect('/notes/' + req.params.topic + "/" + req.params.presentation + "/1");
  });
  ...
  router.post('/signup', passport.authenticate('local-signup', {
        successRedirect: '/notes', // presentation displayed
        failureRedirect: '/notes' // login displayed, errors are shown
      })
  );
